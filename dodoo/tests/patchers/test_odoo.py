...
class TestOdooPatcher:
    def test_apply(self, confd):
        ...
        correct_module = "dodoo.patchers.odoo"
        ...
        func = odoo.modules.module.ad_paths
        assert odoo_interface.Patchable().ad_paths is func
        assert func.__func__.__module__ == correct_module
        ...
        func = odoo.tools.config.configmanager.verify_admin_password
